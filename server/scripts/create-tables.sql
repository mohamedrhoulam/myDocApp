...
CREATE TABLE MEDICINE (
    MED_serialNum VARCHAR(255) PRIMARY KEY,
...
CREATE TABLE PRESCRIPTION (
    ...
    MED_serialNum VARCHAR(255),
    EMP_ID INT,
    FOREIGN KEY (DOC_ID) REFERENCES DOCUMENT(DOC_ID),
    FOREIGN KEY (EMP_ID) REFERENCES EMPLOYEE(EMP_ID), 
	FOREIGN KEY (MED_serialNum) REFERENCES MEDICINE(MED_serialNum)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
CREATE TABLE STOCK (
    ...
    PRIMARY KEY (PROV_ID, MED_serialNum),
